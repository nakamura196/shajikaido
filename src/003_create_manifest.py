...
prefix = "https://nakamura196.github.io/shajikaido"
odir = "../docs"
path = "data/main.xlsx"
...
df_media = pd.read_excel(path, sheet_name="media", header=None, index_col=None)
df_toc = pd.read_excel(path, sheet_name="toc", header=None, index_col=None)
